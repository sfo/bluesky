...
class metric_CoCa():
    ...
    def applyMetric(self):
        ...
        bs.logger.info("Iteration number: "+str(self.iteration+1))
        bs.logger.info("Reset time = "+str(self.resettime))
        return
...
class metric_HB():
    ...
    def applymetric(self):
        ...
        time2 = time()
        bs.logger.info("Time to Complete Calculation: " + str(time2-time1))
    ...
    def apply_twoCircleMethod(self):
        ...
        bs.logger.info("Complexity per Aircraft: " + str(self.complexity[self.step][1]))
        return
...
#        self.write(0.0,"Header info tbd")
    ...
    def update(self):
        ...
        bs.logger.info("Number of Aircraft in Research Area (FIR):" + str(self.metric[self.metric_number].ntraf))
